...
void Robot_GoForward(uint8_t Left_Speed_Percent,uint8_t Right_Speed_Percent)
{
	...
	Motor_Configure_PWM(Motor_Drive_ForwardDirection_1_Channel,(uint8_t)(Left_Speed_Percent*70/100));
	Motor_Configure_PWM(Motor_Drive_ForwardDirection_2_Channel,(uint8_t)(Right_Speed_Percent*70/100));
}

void Robot_GoBackward(uint8_t Left_Speed_Percent,uint8_t Right_Speed_Percent)
{
	Motor_Configure_PWM(Motor_Drive_BackwardDirection_1_Channel,(uint8_t)(Left_Speed_Percent*70/100));
	Motor_Configure_PWM(Motor_Drive_BackwardDirection_2_Channel,(uint8_t)(Right_Speed_Percent*70/100));
